...
object DataDoaDzikir {
    ...
    val listDzikirPagi: List<DoadanDzikirItem>
        get() {
            val listData = mutableListOf<DoadanDzikirItem>()
            for (index in descDzikirPagi.indices) {
                val data = DoadanDzikirItem(
                    descDzikirPagi[index],
                    lafazDzikirPagi[index],
                    terjemahDzikirPagi[index]
                )
                listData.add(data)
            }
            return listData
    ...
    val listDzikirPetang: List<DoadanDzikirItem>
        get() {
            val listData = mutableListOf<DoadanDzikirItem>()
            for (index in descDzikirPetang.indices) {
                val data = DoadanDzikirItem(
                    descDzikirPetang[index],
                    lafazDzikirPetang[index],
                    terjemahDzikirPetang[index]
                )
                listData.add(data)
            }
            return listData
